/*=======================================================================================================================================
Compromiso Gestion: MC-03 | Recién nacidos del departamento,reciben vacunas BCG, HvB, controles CRED y tamizaje neonataL.

Indicador	:	MC-03.01  | Porcentaje de recién nacidos del departamento,reciben vacunas BCG, HvB, controles CRED y tamizaje neonatal.
...
if object_id(N'FED25.TRAMAHIS_FED2024_25_MC03_nominal_2025', N'U') is not null drop table FED25.TRAMAHIS_FED2024_25_MC03_nominal_2025;
...
, a.*
into FED25.TRAMAHIS_FED2024_25_MC03_nominal_2025
...
from FED25.TRAMAHIS_FED2024_25_MC03_nominal_2025
-- from #TRAMAHIS_FED2024_25_MC03_nominal
